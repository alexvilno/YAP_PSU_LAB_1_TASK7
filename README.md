...
информация о t3 (вершина A изменена)
...
```
*P.S. в методе* ```ShowInfo()``` *использованы все методы, определенные для класса **Triangle**, поэтому считать эти методы протестированными. Тесты корректности работы всех методов были проведены с помощью сервиса* **[triange calculator](https://www.triangle-calculator.com/?what=vc)**. 
